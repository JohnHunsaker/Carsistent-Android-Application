...
public class RepairMenu extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView mile = (TextView) findViewById(R.id.mi);
        mile.setTextSize(23);
        ...
        CheckBox boxoil = (CheckBox) findViewById(R.id.c0);
        boxoil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setOilm(ServiceEvent.getCmi());
                EnterVehicleHistory.setOild(ServiceEvent.getDt());
            }
        });

        CheckBox boxeaf = (CheckBox) findViewById(R.id.c1);
        boxeaf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setEafm(ServiceEvent.getCmi());
                EnterVehicleHistory.setEafd(ServiceEvent.getDt());
            }
        });

        CheckBox boxtrans = (CheckBox) findViewById(R.id.c2);
        boxtrans.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setTransm(ServiceEvent.getCmi());
                EnterVehicleHistory.setTransd(ServiceEvent.getDt());
            }
        });

        CheckBox boxsteer = (CheckBox) findViewById(R.id.c3);
        boxsteer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setSteerm(ServiceEvent.getCmi());
                EnterVehicleHistory.setSteerd(ServiceEvent.getDt());
            }
        });

        CheckBox boxcool = (CheckBox) findViewById(R.id.c4);
        boxcool.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setEcoolm(ServiceEvent.getCmi());
                EnterVehicleHistory.setEcoold(ServiceEvent.getDt());
            }
        });

        CheckBox boxthrot = (CheckBox) findViewById(R.id.c5);
        boxthrot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setThrottlem(ServiceEvent.getCmi());
                EnterVehicleHistory.setThrottled(ServiceEvent.getDt());
            }
        });

        CheckBox boxbatt = (CheckBox) findViewById(R.id.c6);
        boxbatt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setBatterym(ServiceEvent.getCmi());
                EnterVehicleHistory.setBatteryd(ServiceEvent.getDt());
            }
        });

        CheckBox boxspark = (CheckBox) findViewById(R.id.c7);
        boxspark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setSparkm(ServiceEvent.getCmi());
                EnterVehicleHistory.setSparkd(ServiceEvent.getDt());
            }
        });

        CheckBox boxrotate = (CheckBox) findViewById(R.id.c8);
        boxrotate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setRotatem(ServiceEvent.getCmi());
                EnterVehicleHistory.setRotated(ServiceEvent.getDt());
            }
        });

        CheckBox boxalign = (CheckBox) findViewById(R.id.c9);
        boxalign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setAlignm(ServiceEvent.getCmi());
                EnterVehicleHistory.setAlignd(ServiceEvent.getDt());
            }
        });

        CheckBox boxfpads = (CheckBox) findViewById(R.id.c10);
        boxfpads.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setFpadsm(ServiceEvent.getCmi());
                EnterVehicleHistory.setFpadsd(ServiceEvent.getDt());
            }
        });

        CheckBox boxrpads = (CheckBox) findViewById(R.id.c12);
        boxrpads.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setRpadsm(ServiceEvent.getCmi());
                EnterVehicleHistory.setRpadsd(ServiceEvent.getDt());
            }
        });

        CheckBox boxflush = (CheckBox) findViewById(R.id.c14);
        boxflush.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setFlushm(ServiceEvent.getCmi());
                EnterVehicleHistory.setFlushd(ServiceEvent.getDt());
            }
        });

        CheckBox boxair = (CheckBox) findViewById(R.id.c15);
        boxair.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setAirm(ServiceEvent.getCmi());
                EnterVehicleHistory.setAird(ServiceEvent.getDt());
            }
        });

        CheckBox boxwiper = (CheckBox) findViewById(R.id.c16);
        boxwiper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EnterVehicleHistory.setWiperm(ServiceEvent.getCmi());
                EnterVehicleHistory.setWiperd(ServiceEvent.getDt());
            }
        });
    }
}